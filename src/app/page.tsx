    ...
    <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            >
              ...
              <p className="text-gray-600">
                Learn from experienced teachers who are masters in traditional Indian classical music
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Structured learning path covering theory, practice, and performance aspects
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Small batch sizes ensuring individual attention and faster progress
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 to-orange-500 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">Begin Your Musical Journey Today</h2>
          <p className="text-xl mb-12 max-w-2xl mx-auto">
            Join our community of passionate learners and start your journey in Indian classical music
          </p>
          <Link
            href="/register"
            className="bg-white text-orange-600 hover:bg-orange-50 px-8 py-3 rounded-full text-lg font-semibold transition-colors inline-block"
          >
            Enroll Now
          </Link>
        </div>
