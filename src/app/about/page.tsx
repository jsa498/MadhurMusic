...
function StatCard({ stat, setIndex }: { stat: any; setIndex?: number }) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{ duration: 0.5, delay: setIndex ? setIndex * 0.1 : 0 }}
          ...
          <div className="container mx-auto px-4">
            <div className="hidden md:grid md:grid-cols-4 gap-8">
              {[
                ...
                <StatCard key={stat.label} stat={stat} setIndex={index} />
              ))}
            </div>
                ...
                {[...Array(8)].map((_, setIndex) => (
                  <div key={setIndex} className="flex gap-4">
                    {[
                      ...
                      <StatCard key={`${setIndex}-${stat.label}`} stat={stat} />
                    ))}
                  </div>
                ))}
              </motion.div>
